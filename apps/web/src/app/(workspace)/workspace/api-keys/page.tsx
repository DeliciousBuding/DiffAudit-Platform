      ...
      <div className="mb-8">
        ...
        {showCreate && !createdKey ? (
          <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
            <h3 className="mb-4 text-sm font-semibold text-foreground">Create a new API key</h3>
            <div className="mb-4">
          ...
          <div className="rounded-2xl border border-[var(--accent-green)]/30 bg-[var(--accent-green)]/5 p-6">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                <h3 className="mb-1 text-sm font-semibold text-foreground">Key created successfully</h3>
