    ...
    <WorkspacePageFrame
      ...
      actions={
        <Link
          ...
          className="workspace-btn-primary inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold rounded-lg shrink-0 shadow-sm hover:shadow-md transition-shadow"
        >
