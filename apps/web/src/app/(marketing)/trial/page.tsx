...
> = {
  "en-US": {
    ...
    externalHint: "If you switch to an external questionnaire later, only `DIFFAUDIT_TRIAL_FORM_URL` needs to change.",
  ...
  "zh-CN": {
    ...
    homeCta: "返回首页",
    externalCta: "打开外部申请表",
    externalHint: "后面如果切到外部问卷，只需要替换 `DIFFAUDIT_TRIAL_FORM_URL`，这个入口页结构不用再重做。",
    localFormEyebrow: "临时站内入口",
    localFormTitle: "当前站内表单保留为兜底入口。",
    localFormBody: "在外部问卷未接入前，你仍可直接在这里收集线索。等公开申请链路切到外部表单后，这一页继续作为品牌化入口与分流页使用。",
