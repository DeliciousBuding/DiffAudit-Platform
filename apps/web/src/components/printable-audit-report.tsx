    ...
    <div style={ROOT_STYLE}>
      ...
      <div data-print-page style={PAGE_STYLE}>
        <header style={{ borderBottom: "1px solid #dbe1ea", paddingBottom: "10px", marginBottom: "16px" }}>
          ...
          <h2 style={{ margin: "8px 0 0", fontSize: "22px", fontWeight: 650 }}>{copy.printableReport.summarySectionTitle}</h2>
        </header>
        ...
        <section style={{ display: "grid", gap: "12px" }}>
          <div style={{ ...SECTION_STYLE, padding: "16px" }}>
            ...
            <p style={{ margin: 0, fontSize: "13px", lineHeight: 1.8, color: "#475569" }}>
              {effectivePairs > 0
                ? copy.printableReport.comparisonSummaryEffective(effectivePairs, comparePairs.length || 1, avgAucReduction.toFixed(3))
                : copy.printableReport.comparisonSummaryIneffective(avgAucReduction.toFixed(3))}
            </p>
          </div>
          <div style={{ ...SECTION_STYLE, padding: "16px" }}>
            ...
            <p style={{ margin: 0, fontSize: "13px", lineHeight: 1.8, color: "#475569" }}>
              {gapData.length > 0
                ? copy.printableReport.coverageGapsHighRisk(gapData.length)
                : copy.printableReport.coverageGapsNone}
            </p>
          </div>
          <div style={{ ...SECTION_STYLE, padding: "16px" }}>
            <div style={{ fontSize: "12px", fontWeight: 700, marginBottom: "8px" }}>{copy.sections.riskDistribution}</div>
            <p style={{ margin: 0, fontSize: "13px", lineHeight: 1.8, color: "#475569" }}>
              {copy.printableReport.riskDistributionDetail(riskCounts.high, riskCounts.medium, riskCounts.low, defendedCount)}
            </p>
          </div>
        </section>
      </div>
