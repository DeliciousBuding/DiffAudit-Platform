...
/**
 * Table — the single data-grid grammar. Replaces the hand-rolled markup in
 * `results-table.tsx` / `contracts-table.tsx` / `sortable-header.tsx` /
 * `clickable-row.tsx`, each of which styled `<th>`/`<tr>`/`<td>` ad hoc. One
 * set of border/radius/text conventions; sort state and row-as-link are
 * composed via `data-slot` hooks, not bespoke classes.
 */
