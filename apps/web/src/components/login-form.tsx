...
function resolveOauthErrorMessage(errorCode: string | null, copy: LoginFormCopy) {
  switch (errorCode) {
    case "oauth_state":
      return copy.oauthErrors.state;
    case "oauth_config":
      return copy.oauthErrors.config;
    case "oauth_network_google":
      return copy.oauthErrors.networkGoogle;
    case "oauth_network_github":
      return copy.oauthErrors.networkGithub;
    case "oauth_token":
      return copy.oauthErrors.token;
    case "oauth_user":
      return copy.oauthErrors.user;
    default:
      return errorCode ? copy.oauthErrors.fallback : null;
  }
}
...
export function LoginForm({
  ...
  const oauthErrorMessage = resolveOauthErrorMessage(oauthError, copy);
