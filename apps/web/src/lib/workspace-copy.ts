  ...
  "en-US": {
    ...
    createTask: {
      ...
      steps: {
        ...
        step1Label: "1",
        step1Title: "Target model",
        step1Desc: "Select the model to audit.",
        step2Label: "2",
        step2Title: "Audit routes",
        step2Desc: "Choose attack methodologies to run on the selected model.",
        step3Label: "3",
