...
> = {
  "en-US": {
    ...
    loginPage: {
      ...
      description: "Passwordless sign-in is the default. The first time you continue with Google or GitHub, we sync profile details like your name and avatar; email may still require verification before it becomes a sign-in ID.",
      formEyebrow: "Workspace access",
      formTitle: "Choose a sign-in method.",
      oauthDivider: "Or continue with",
      passwordDivider: "Use username and password",
      hidePasswordCta: "Back",
      providerHint: "We only read your name, email, and avatar to create your account and sign you in.",
    ...
    registerPage: {
      ...
      formTitle: "Create a username and password.",
    ...
    loginForm: {
      ...
      submit: "Sign in",
      pending: "Signing in...",
      hint: "Password fallback accepts either your username or email.",
  ...
  "zh-CN": {
    ...
    loginPage: {
      ...
      description: "默认走无密码登录。首次用 Google 或 GitHub 继续时会同步名称与头像；邮箱会在可信后进入正式登录标识，必要时需要后续验证。",
      formEyebrow: "工作台访问",
      formTitle: "选择你的登录方式。",
      oauthDivider: "或使用以下方式继续",
      passwordDivider: "使用账号密码登录",
      hidePasswordCta: "返回",
      providerHint: "我们只会读取你的名称、邮箱和头像，用于建号和登录。",
      registerLink: "需要本地账号？",
      registerCta: "创建一个",
      google: "使用 Google 继续",
      github: "使用 GitHub 继续",
