...
const catalogEntries: CatalogEntryPayload[] = [
  {
    ...
    scheduler: "ddim",
    best_summary_path: "research://summaries/recon.json",
  ...
  },
  {
    ...
    backend: null,
    scheduler: null,
    best_summary_path: "research://summaries/pia.json",
  ...
  },
  {
    ...
    backend: null,
    scheduler: null,
    best_summary_path: "research://summaries/gsa.json",
          ...
          entries: [
            {
              ...
              bestSummaryPath: "research://summaries/recon.json",
              systemGap: "surface semantic limits cleanly",
              admissionStatus: "admitted",
              admissionLevel: "runtime-mainline",
              provenanceStatus: "workspace-verified",
              intakeManifest: "workspaces/intake/manifests/recon.json",
            },
          ],
        },
        {
          ...
          entries: [
            {
              ...
              paper: "PIA",
              runtimeLabel: "unassigned runtime",
              bestWorkspace: "pia-cifar10-runtime-mainline-20260407-cpu",
              bestSummaryPath: "research://summaries/pia.json",
          ...
          entries: [
            {
              ...
              bestSummaryPath: "research://summaries/gsa.json",
        ...
        entries: [
          {
            ...
            systemGap: "pending system gap explanation",
          },
        ],
      },
      {
