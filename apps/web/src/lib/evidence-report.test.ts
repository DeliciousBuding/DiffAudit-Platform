      ...
      .mockResolvedValueOnce(
        new Response(
          JSON.stringify({
            status: "ready",
            workspace:
              "research://experiments/recon-runtime-mainline-ddim-public-100-step30",
            summary_path:
              "research://experiments/recon-runtime-mainline-ddim-public-100-step30/summary.json",
          }),
          { status: 200, headers: { "content-type": "application/json" } },
        ),
      );
      ...
      .mockResolvedValueOnce(
        new Response(
          JSON.stringify({
            ...
            scheduler: null,
            workspace:
              "research://experiments/pia-cifar10-runtime-mainline-20260407-cpu",
          }),
          { status: 200, headers: { "content-type": "application/json" } },
        ),
      );
